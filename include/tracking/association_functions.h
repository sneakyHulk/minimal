...
namespace tracking {
	constexpr auto iou = [](BoundingBoxType auto const& bbox1, BoundingBoxType auto const& bbox2) {
	...
	constexpr auto diou = [](BoundingBoxType auto const& bbox1, BoundingBoxType auto const& bbox2) {
